...
static result_t container_critbit__insert(icontainer_t *c_,
                                          const void   *key,
                                          const void   *value)
{
...
static result_t container_critbit__lookup_prefix(const icontainer_t        *c_,
                                                 const void                *prefix,
...
static result_t container_critbit__show(const icontainer_t *c_, FILE *f)
{
  container_critbit_t *c = (container_critbit_t *) c_;
...
static result_t container_critbit__show_viz(const icontainer_t *c_, FILE *f)
{
  container_critbit_t *c = (container_critbit_t *) c_;
...
result_t container_create_critbit(icontainer_t            **container,
